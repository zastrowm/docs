...
This example demonstrates the [“Agent as Tool Pattern”](/user-guide/concepts/multi-agent/agents-as-tools/index.md) where Strands agents are wrapped as tools. These tools are then provided to another agent (the Teacher’s Assistant), creating a system where agents can use other agents as tools.

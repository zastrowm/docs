...
-   `model`: Model identifier (string) - \[[Only supports AWS Bedrock model provider string](/user-guide/quickstart/index.md#using-a-string-model-id)\]

...
-   [**OutputEvaluator**](/user-guide/evals-sdk/evaluators/output_evaluator/index.md): LLM-based output evaluation with custom rubrics
-   [**TrajectoryEvaluator**](/user-guide/evals-sdk/evaluators/trajectory_evaluator/index.md): Sequence-based evaluation

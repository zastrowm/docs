...
2.  **Multi-Agent Shared State**: In [Graph](/user-guide/concepts/multi-agent/graph/index.md) and [Swarm](/user-guide/concepts/multi-agent/swarm/index.md) patterns, access state shared across all agents
...
(( tab "Python" ))
Async tools can yield intermediate results to provide real-time progress updates. Each yielded value becomes a [streaming event](/user-guide/concepts/streaming/index.md), with the final value serving as the tool’s return result:

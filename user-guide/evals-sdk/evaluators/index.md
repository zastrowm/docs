...
**[OutputEvaluator](/user-guide/evals-sdk/evaluators/output_evaluator/index.md)**

-   **Level**: OUTPUT\_LEVEL
-   **Purpose**: Flexible LLM-based evaluation with custom rubrics
-   **Use Case**: Assess any subjective quality (safety, relevance, tone)

**[HelpfulnessEvaluator](/user-guide/evals-sdk/evaluators/helpfulness_evaluator/index.md)**

-   **Level**: TRACE\_LEVEL
-   **Purpose**: Evaluate response helpfulness from user perspective
-   **Use Case**: Measure user satisfaction and response utility

**[FaithfulnessEvaluator](/user-guide/evals-sdk/evaluators/faithfulness_evaluator/index.md)**
...
**[ToolSelectionEvaluator](/user-guide/evals-sdk/evaluators/tool_selection_evaluator/index.md)**

-   **Level**: TRACE\_LEVEL
-   **Purpose**: Evaluate whether correct tools were selected
-   **Use Case**: Assess tool choice accuracy in multi-tool scenarios

**[ToolParameterEvaluator](/user-guide/evals-sdk/evaluators/tool_parameter_evaluator/index.md)**
...
**[TrajectoryEvaluator](/user-guide/evals-sdk/evaluators/trajectory_evaluator/index.md)**
...
**[InteractionsEvaluator](/user-guide/evals-sdk/evaluators/interactions_evaluator/index.md)**
...
**[GoalSuccessRateEvaluator](/user-guide/evals-sdk/evaluators/goal_success_rate_evaluator/index.md)**
...
**[CustomEvaluator](/user-guide/evals-sdk/evaluators/custom_evaluator/index.md)**
...
-   [OutputEvaluator](/user-guide/evals-sdk/evaluators/output_evaluator/index.md): Start with flexible custom evaluation
-   [HelpfulnessEvaluator](/user-guide/evals-sdk/evaluators/helpfulness_evaluator/index.md): Assess response helpfulness
-   [CustomEvaluator](/user-guide/evals-sdk/evaluators/custom_evaluator/index.md): Create domain-specific evaluators

## Related Documentation

-   [Quickstart Guide](/user-guide/quickstart/index.md): Get started with Strands Evals
-   [Simulators Overview](/user-guide/evals-sdk/simulators/index.md): Learn about simulators
-   [Experiment Generator](/user-guide/evals-sdk/experiment_generator/index.md): Generate test cases automatically
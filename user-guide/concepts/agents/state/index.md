...
See [Conversation Management](/user-guide/concepts/agents/conversation-management/index.md) for more information about conversation managers.
...
To use `ToolContext` in your tool function, the parameter must be named `tool_context`. See [ToolContext documentation](/user-guide/concepts/tools/custom-tools/index.md#toolcontext) for more information.
...
For information on how to persist agent state and conversation history across multiple interactions or application restarts, see the [Session Management](/user-guide/concepts/agents/session-management/index.md) documentation.
...
-   [**FaithfulnessEvaluator**](/user-guide/evals-sdk/evaluators/faithfulness_evaluator/index.md): Evaluates if responses are grounded in context
-   [**OutputEvaluator**](/user-guide/evals-sdk/evaluators/output_evaluator/index.md): Evaluates overall output quality with custom criteria
-   [**GoalSuccessRateEvaluator**](/user-guide/evals-sdk/evaluators/goal_success_rate_evaluator/index.md): Evaluates if overall user goals were achieved
-   [**TrajectoryEvaluator**](/user-guide/evals-sdk/evaluators/trajectory_evaluator/index.md): Evaluates the sequence of actions taken
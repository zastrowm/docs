...
Defined in: [src/tools/zod-tool.ts:231](https://github.com/strands-agents/sdk-typescript/blob/3d31e16991c3f9724599e58789ad8dcd94fe06b3/src/tools/zod-tool.ts#L231)
...
| `TReturn` *extends* [`JSONValue`](/api/typescript/JSONValue/index.md) | [`JSONValue`](/api/typescript/JSONValue/index.md) | Return type of the callback function |
...
[`InvokableTool`](/api/typescript/InvokableTool/index.md)<`ZodInferred`<`TInput`\>, `TReturn`\>

...
-   **Strands Eval SDK**: [Eval SDK Documentation](/user-guide/evals-sdk/quickstart/index.md)

## Related Tools

-   [**Strands Evaluation SDK**](/user-guide/evals-sdk/quickstart/index.md): Core evaluation framework and evaluators
-   [**Experiment Generator**](/user-guide/evals-sdk/experiment_generator/index.md): Automated test case generation
-   [**Output Evaluator**](/user-guide/evals-sdk/evaluators/output_evaluator/index.md): Custom rubric-based evaluation
-   [**Trajectory Evaluator**](/user-guide/evals-sdk/evaluators/trajectory_evaluator/index.md): Tool usage and sequence analysis

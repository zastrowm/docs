...
-   **Docker deployment guide completed** - You must have a working containerized agent before proceeding:
    -   [Python Docker guide](/user-guide/deploy/deploy_to_docker/python/index.md)
    -   [TypeScript Docker guide](/user-guide/deploy/deploy_to_docker/typescript/index.md)
...
Cloud deployment requires your containerized agent to be available in a container registry. The following assumes you have completed the [Docker deployment guide](/user-guide/deploy/deploy_to_docker/index.md) and pushed your image to the appropriate registry:
...
-   [Strands Docker Deploy Documentation](/user-guide/deploy/deploy_to_docker/index.md)

...
Bidirectional streaming uses a different event model than [standard streaming](/user-guide/concepts/streaming/index.md):
...
See [Connection Lifecycle](/user-guide/concepts/bidirectional-streaming/agent/index.md#connection-restart) for more details on timeout handling.
...
Emitted when the model requests tool execution. See [Tools Overview](/user-guide/concepts/tools/index.md) for details.
...
For details on hook events and usage patterns, see the [Hooks](/user-guide/concepts/bidirectional-streaming/hooks/index.md) documentation.
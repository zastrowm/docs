...
-   **Large refactors without prior discussion** — Major architectural changes require a [feature proposal](/contribute/contributing/feature-proposals/index.md)
-   **Breaking changes without approval** — We maintain backward compatibility carefully. Breaking changes require a [feature proposal](/contribute/contributing/feature-proposals/index.md)
-   **External tools** — [Build your own extension](/contribute/contributing/extensions/index.md) instead for full ownership
...
-   [Feature proposals](/contribute/contributing/feature-proposals/index.md) — For significant features requiring discussion

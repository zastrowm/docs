...
| Parameter | Type |
| --- | --- |
| `data` | { `agent`: [`AgentData`](/api/typescript/AgentData/index.md); `stopData?`: [`ModelStopResponse`](/api/typescript/ModelStopResponse/index.md); `error?`: `Error`; } |
| `data.agent` | [`AgentData`](/api/typescript/AgentData/index.md) |
| `data.stopData?` | [`ModelStopResponse`](/api/typescript/ModelStopResponse/index.md) |
| `data.error?` | `Error` |

...
llama.cpp models support structured output through native JSON schema validation. When you use [`Agent.structured_output()`](/api/python/strands.agent.agent#Agent.structured_output), the SDK uses llama.cpp’s json\_schema parameter to constrain output:

...
### When to Use [Graph](/user-guide/concepts/multi-agent/graph/index.md)
...
### When to Use [Swarm](/user-guide/concepts/multi-agent/swarm/index.md)
...
-   Software Development: As shown in the [`Swarm` documentation](/user-guide/concepts/multi-agent/swarm/index.md#how-swarms-work), a researcher hands off to an architect, who hands off to a coder, who hands off to a reviewer. The path is emergent.

### When to Use [Workflow](/user-guide/concepts/multi-agent/workflow/index.md)
...
-   Tools via `ToolContext` when using `@tool(context=True)` - see [Python Tools](/user-guide/concepts/tools/custom-tools/index.md#accessing-state-in-tools)
-   Tool-related hooks (BeforeToolCallEvent, AfterToolCallEvent) - see [Hooks](/user-guide/concepts/agents/hooks/index.md#accessing-invocation-state-in-hooks)
...
-   [Graph Documentation](/user-guide/concepts/multi-agent/graph/index.md)
-   [Swarm Documentation](/user-guide/concepts/multi-agent/swarm/index.md)
-   [Workflow Documentation](/user-guide/concepts/multi-agent/workflow/index.md)
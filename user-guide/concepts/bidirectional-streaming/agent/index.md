...
See [Model Providers](/user-guide/concepts/bidirectional-streaming/models/nova_sonic/index.md) for provider-specific options.

`BidiAgent` supports many of the same constructs as `Agent`:

-   **[Tools](/user-guide/concepts/tools/index.md)**: Function calling works identically
-   **[Hooks](/user-guide/concepts/bidirectional-streaming/hooks/index.md)**: Lifecycle event handling with bidirectional-specific events
-   **[Session Management](/user-guide/concepts/bidirectional-streaming/session-management/index.md)**: Conversation persistence across sessions
-   **[Tool Executors](/user-guide/concepts/tools/executors/index.md)**: Concurrent and custom execution patterns
...
-   [I/O Channels](/user-guide/concepts/bidirectional-streaming/io/index.md) - Building custom input/output channels
-   [Model Providers](/user-guide/concepts/bidirectional-streaming/models/nova_sonic/index.md) - Provider-specific configuration
-   [Quickstart](/user-guide/concepts/bidirectional-streaming/quickstart/index.md) - Getting started guide

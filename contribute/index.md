...
| --- | --- | --- |
| Fix a bug | Check for existing issues, submit a PR with tests that verify your fix | [SDK](/contribute/contributing/core-sdk/index.md) |
| Add a new feature | For small changes, open an issue first. For larger features, write a design document to align on direction | [Feature Proposals](/contribute/contributing/feature-proposals/index.md) |
| Improve the docs | Fix typos, clarify explanations, add examples, or write new guides | [Documentation](/contribute/contributing/documentation/index.md) |
...
| I want to… | What it involves | Guide |
| --- | --- | --- |
| Publish an extension | Package your component and publish to PyPI so others can use it | [Publishing Extensions](/contribute/contributing/extensions/index.md) |

## Community resources

-   [Community Catalog](/community/community-packages/index.md) — Discover community-built extensions

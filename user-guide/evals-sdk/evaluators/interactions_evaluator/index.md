...
-   [**TrajectoryEvaluator**](/user-guide/evals-sdk/evaluators/trajectory_evaluator/index.md): Evaluates tool call sequences (single agent)
-   [**GoalSuccessRateEvaluator**](/user-guide/evals-sdk/evaluators/goal_success_rate_evaluator/index.md): Evaluates overall goal achievement
-   [**OutputEvaluator**](/user-guide/evals-sdk/evaluators/output_evaluator/index.md): Evaluates final output quality
-   [**HelpfulnessEvaluator**](/user-guide/evals-sdk/evaluators/helpfulness_evaluator/index.md): Evaluates individual response helpfulness
...
Strands Agents Tools is a community-driven project that provides a powerful set of tools for your agents to use. For more information, see [Strands Agents Tools](/user-guide/concepts/tools/community-tools-package/index.md).
...
Agents have context about tool calls and their results as part of conversation history. See [Using State in Tools](/user-guide/concepts/agents/state/index.md#using-state-in-tools) for more information.
...
For more details, see [Tool Executors](/user-guide/concepts/tools/executors/index.md).
(( /tab "Python" ))
...
For more details on building custom tools, see [Creating Custom Tools](/user-guide/concepts/tools/custom-tools/index.md).
(( /tab "TypeScript" ))
...
For more details on building custom Python tools, see [Creating Custom Tools](/user-guide/concepts/tools/custom-tools/index.md).
(( /tab "Python" ))
...
For a complete list of available tools, see [Community Tools Package](/user-guide/concepts/tools/community-tools-package/index.md).
(( /tab "Python" ))
...
For more information on using MCP tools, see [MCP Tools](/user-guide/concepts/tools/mcp-tools/index.md).

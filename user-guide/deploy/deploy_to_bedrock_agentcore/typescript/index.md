This guide covers deploying TypeScript-based Strands agents to [Amazon Bedrock AgentCore Runtime](/user-guide/deploy/deploy_to_bedrock_agentcore/index.md) using Express and Docker.

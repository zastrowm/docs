...
-   [Output Evaluator](/docs/user-guide/evals-sdk/evaluators/output_evaluator/index.md) - Detailed guide to LLM-based output evaluation
-   [Trajectory Evaluator](/docs/user-guide/evals-sdk/evaluators/trajectory_evaluator/index.md) - Comprehensive tool usage and sequence evaluation

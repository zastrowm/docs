...
-   [**OutputEvaluator**](/user-guide/evals-sdk/evaluators/output_evaluator/index.md): Evaluates the quality of final outputs
-   [**ToolParameterAccuracyEvaluator**](/user-guide/evals-sdk/evaluators/tool_parameter_evaluator/index.md): Evaluates if tool parameters are correct
-   [**ToolSelectionAccuracyEvaluator**](/user-guide/evals-sdk/evaluators/tool_selection_evaluator/index.md): Evaluates if correct tools were selected
-   [**GoalSuccessRateEvaluator**](/user-guide/evals-sdk/evaluators/goal_success_rate_evaluator/index.md): Evaluates if overall goals were achieved
...
-   **[Async Iterators](/user-guide/concepts/streaming/async-iterators/index.md)**: Ideal for asynchronous server frameworks
-   **[Callback Handlers (Python only)](/user-guide/concepts/streaming/callback-handlers/index.md)**: Perfect for synchronous applications and custom event processing
...
-   **`tool_stream_event`**: Information about [an event streamed from a tool](/user-guide/concepts/tools/custom-tools/index.md#tool-streaming), including:
...
(( tab "Python" ))
Multi-agent systems ([Graph](/user-guide/concepts/multi-agent/graph/index.md) and [Swarm](/user-guide/concepts/multi-agent/swarm/index.md)) emit additional coordination events:
...
See [Graph streaming](/user-guide/concepts/multi-agent/graph/index.md#streaming-events) and [Swarm streaming](/user-guide/concepts/multi-agent/swarm/index.md#streaming-events) for usage examples.
(( /tab "Python" ))
...
Utilizing both [agents as a tool](/user-guide/concepts/multi-agent/agents-as-tools/index.md) and [tool streaming](/user-guide/concepts/tools/custom-tools/index.md#tool-streaming), this example shows how to stream events from sub-agents:
...
-   Learn about [Async Iterators](/user-guide/concepts/streaming/async-iterators/index.md) for asynchronous streaming
-   Explore [Callback Handlers](/user-guide/concepts/streaming/callback-handlers/index.md) for synchronous event processing

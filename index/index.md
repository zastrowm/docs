...
> Different model providers can be configured for agents by following the [quickstart guide](/user-guide/quickstart/index.md#model-providers).

> See [Bedrock troubleshooting](/user-guide/concepts/model-providers/amazon-bedrock/index.md#troubleshooting) if you encounter any issues.
...
-   [Quickstart](/user-guide/quickstart/index.md) - A more detailed introduction to Strands Agents
-   [Examples](/examples/index.md) - Examples for many use cases, types of agents, multi-agent systems, autonomous agents, and more
-   [Community Supported Tools](/user-guide/concepts/tools/community-tools-package/index.md) - The [`strands-agents-tools`](https://github.com/strands-agents/tools) package is a community-driven project that provides a powerful set of tools for your agents to use
